    ...
    bookList.forEach((book, index) => {
       ...
       <div class="col-5 my-2 ${index % 2 == 0 &&"offset-2"}">
                <div class="row book__card">
                    <div class="col-6">
                        <img src=" ${book.imgSource}" class="shadow img-fluid" width="258px" height="400px">
                    </div>
                    <div class="col-6 d-flex flex-column justify-content-center gap-4">
                        ...
                        <p class="book__description gray">${book.description}</p>
                        <div>
...
const createBookTypesHtml = () => {
    //Filtre elemanını seç 
   const filterEle = document.querySelector(".filter");
   //filter html içeriğini tutacak değişken
   let filterHtml = "";
   //filtre türlerini tutacak dizi,"ALL" türüyle başlatılmıştır
   let filterTypes = ["ALL"];
   bookList.forEach((book) => {
    //eğer filter türleri dizisinde bu tür bulunmuyorsa ekle
   ...
   //oluşturulan HTML i filtreleme elemanına ekle
...
const listBasketItems = () => {
    ...
    let basketCountEl = document.querySelector(".basket__count");
